...
func IsEmailExists(db DBTX, email string) (bool, error) {
	var exists bool
...
func GetUserIdByEmail(db DBTX, email string) (uuid.UUID, error) {
...
func AddUser(db DBTX, id uuid.UUID, username string, email string) error {
